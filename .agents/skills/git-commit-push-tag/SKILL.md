...
description: >-
  ...
  explicitly validated commit, release-identification artifacts, remote audit
  preflight, tag, atomic final push, synchronization checks, and an optional
  template-based GitHub Release.
